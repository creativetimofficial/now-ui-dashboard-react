  ...
  _createClass(CarouselItem, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          slide = _props.slide,
          transitionProps = _objectWithoutProperties(_props, ['src', 'altText', 'in', 'children', 'cssModule', 'slide']);

      var imgClasses = (0, _utils.mapToCssModules)((0, _classnames2.default)('d-block', 'img-fluid'), cssModule);
      ...
      return _react2.default.createElement(
        ...
        function (status) {
          ...
          var itemClasses = (0, _utils.mapToCssModules)((0, _classnames2.default)('carousel-item', isActive && 'active', directionClassName, orderClassName), cssModule);

          return _react2.default.createElement(
            'div',
            { className: itemClasses },
            _react2.default.createElement('img', { className: imgClasses, src: src, alt: altText }),
            children
          );
        }
      );
...
CarouselItem.propTypes = _extends({}, _Transition2.default.propTypes, {
  ...
  children: _propTypes2.default.shape({
    type: _propTypes2.default.oneOf([_CarouselCaption2.default])
  }),
