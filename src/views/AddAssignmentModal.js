...
function AddAssignmentModal({ toggleShowAddAssignmentModal }) {
    ...
    const [formData, setFormData] = useState({name: "", assignment:"", courseId: ""})
        ...
        <>
            ...
            <div className="modal-wrapper">
                <form onSubmit={addAssignment}>
                    <p style={{"margin-left": "auto", "cursor": "pointer"}} onClick={toggleShowAddAssignmentModal}>X</p>
                    <label htmlFor="name">Enter Assignment Name</label>
                    <input type="text" name="name" id="name" value={formData.name} onChange={handleChange} required/>
                    <label htmlFor="courseid">Enter Course ID</label>
                    <input type="text" name="courseId" id="courseId" value={formData.courseId} onChange={handleChange} required/>
                    <label htmlFor="assignment">Add Assignment Content</label>
                    <input type="file" name="assignment" id="assignment" onChange={handleFileChange} />
