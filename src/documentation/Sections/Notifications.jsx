...
class Notifications extends React.Component{
    ...
    render(){
        return (
            <div>
                <Notify ref="notify"/>
                <h1 className="bd-title" id="content">React Notification Alert v0.0.7</h1>
                <p className="bd-lead">
                    We are very proud to present you our new <code>notification system</code>. It was coded by us from scratch, so you won't have to install any third libraries.
                </p>
                <h2>Styles</h2>
                ...
                <p>After that, you have to call the <code>notificationAlert function</code> from this component with some <code>options</code>:</p>
                <SyntaxHighlighter language="jsx" style={prism}>
                    {codeExamplePlacesOptions}
                </SyntaxHighlighter>
                <h2>Props passed in <code>notificationAlert function</code></h2>
                <p>Please refer to <a href="https://github.com/creativetimofficial/react-notification-alert" target="_blank" rel="noopener noreferrer">react-notification-alert documentation</a>.</p>
