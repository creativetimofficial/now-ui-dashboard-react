    ...
    render(){
        return (
            <div>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeHeadings}</SyntaxHighlighter>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeClases}</SyntaxHighlighter>
                <p><code className="highlighter-rouge">.title</code>, for when you want some bolder titles with a different font family.</p>
                <div className="bd-example">
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeTitle}</SyntaxHighlighter>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeSmall}</SyntaxHighlighter>
                <h2>Blockquotes</h2>
                <p>For quoting blocks of content from another source within your document. Wrap <code className="highlighter-rouge">&lt;blockquote className="blockquote"&gt;</code> around any <abbr title="HyperText Markup Language">HTML</abbr> as the quote.</p>
                <div className="bd-example">
                    <blockquote className="blockquote">
                        <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
                    </blockquote>
                </div>
                <SyntaxHighlighter language="jsx" style={prism}>{codeBlockquote}</SyntaxHighlighter>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeSource}</SyntaxHighlighter>
                <h3>Alignment</h3>
                <div className="bd-example">
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeAlignment1}</SyntaxHighlighter>
                <div className="bd-example">
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeAlignment2}</SyntaxHighlighter>
            </div>
        );
    }
}
