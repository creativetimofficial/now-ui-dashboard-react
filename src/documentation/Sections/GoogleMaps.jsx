...
class GoogleMaps extends React.Component{
    render(){
        return (
            <div>
                <h1 className="bd-title" id="content">React Google Maps v9.2.2</h1>
                <p className="bd-lead">
                    For maps we've used some components from a react library <a href="https://github.com/tomchentw/react-google-maps" target="_blank" rel="noopener noreferrer">react-google-maps</a>.
                </p>
                ...
                <h2>Example</h2>
                <p>
                    First of all, you will need the following imports:
                </p>
                <SyntaxHighlighter language="jsx" style={prism}>
                    {codeImport}
                </SyntaxHighlighter>
                <p>
                    You will have to create a variable for the map:
                </p>
                <SyntaxHighlighter language="jsx" style={prism}>
                    {codeExample}
                </SyntaxHighlighter>
                <p>
                    After that, in your render method you will have to add:
                </p>
                <SyntaxHighlighter language="jsx" style={prism}>
                    {codeExampleRender}
                </SyntaxHighlighter>
                ...
                <h2>Props</h2>
                <p>Please refer to <a href="https://github.com/tomchentw/react-google-maps" target="_blank" rel="noopener noreferrer">react-google-maps documentation</a>.</p>
            </div>
        );
    }
}
