...
import Tables from 'views/Table/Tables.jsx';
...
const appRoutes = [
    ...
    { path: "/table", name: "Table List", icon: "text_align-center" , component: Tables },
    { path: "/typography", name: "Typography", icon: "files_paper" , component: Typography },
