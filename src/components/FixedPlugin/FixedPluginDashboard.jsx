                ...
                <div className={this.state.classes}>
                    ...
                    <ul className="dropdown-menu show">
                        ...
                        <li className="button-container">{
                            ...
                            }<a href="https://www.creative-tim.com/product/now-ui-dashboard-pro-react" target="_blank" className="btn btn-primary btn-block btn-round">Buy pro</a>
                            {
                            // eslint-disable-next-line
                            }<a href="https://www.creative-tim.com/product/now-ui-dashboard-react" target="_blank" className="btn btn-warning btn-block btn-round">Download free</a>
                            <NavLink to={'/documentation/tutorial'} className="btn btn-block btn-round btn-info" activeClassName="active">
                                Documentation
                            </NavLink>
                        </li>
            			<li className="header-title" id="sharrreTitle">Thank you for sharing!</li>
                        <li className="button-container text-center">
                            <FacebookShareButton url="https://nud-react.creative-tim.com"><FacebookIcon size={32} round={true}/></FacebookShareButton>
                            <TwitterShareButton url="https://nud-react.creative-tim.com" title="Light Bootstrap Dashboard React - Free Bootstrap Admin Template" hashtags={["react","bootstrap"]} via="creativetim"><TwitterIcon size={32} round={true}/></TwitterShareButton>
                            <br />
