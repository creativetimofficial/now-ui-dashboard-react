...
class CardElements extends React.Component{
    render(){
        return (
            <div>
                <h1 className="bd-title" id="content">Card elements</h1>
                <p className="bd-lead">
                    We've added some extra elements for this component (<a href="https://reactstrap.github.io/components/card/" target="_blank" rel="noopener noreferrer">reactstrap card</a>).
                </p>
                <h2>Imports</h2>
                <p>
                    To use our custom made elements for this component you need to import them like so:
                </p>
                <SyntaxHighlighter language="jsx" style={prism}>{codeImportExample}</SyntaxHighlighter>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeAuthorExample}</SyntaxHighlighter>
                <SyntaxHighlighter language="jsx" style={prism}>{codeAuthorProp}</SyntaxHighlighter>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeSocialsExample}</SyntaxHighlighter>
                <SyntaxHighlighter language="jsx" style={prism}>{codeSocialsProp}</SyntaxHighlighter>
            </div>
        );
    }
}
