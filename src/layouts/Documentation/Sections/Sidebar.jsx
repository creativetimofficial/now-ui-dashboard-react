...
class Sidebar extends React.Component{
    render(){
        return (
            <div>
                <h1 className="bd-title" id="content">Sidebar</h1>
                <p className="bd-lead">
                    We have created a component for the main navigation of this dashboard, <code>Sidebar</code>, which is located in <code>src/components/Sidebar/Sidebar.jsx</code>. It contains the company title, a photo of the logged in user with options inside a dropdown, and a list of all the pages. Every element in the list of pages can have a sublist of pages.
                </p>
                <p>
                    To use it, you need to import it:
                </p>
                <SyntaxHighlighter language="jsx" style={prism}>{`import { Sidebar } from 'components';`}</SyntaxHighlighter>
                ...
                <p>Our <code>routes</code> for this dashboard can be found in <code>src/routes</code>.</p>
            </div>
        );
    }
}
