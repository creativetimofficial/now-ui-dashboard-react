...
class Tasks extends React.Component{
    render(){
        return (
            <div>
                <h1 className="bd-title" id="content">Tasks</h1>
                <p className="bd-lead">We've created a special component to render the tasks list shown in <Link to="/widgets">Widgets</Link> <code>Task</code> card.</p>
