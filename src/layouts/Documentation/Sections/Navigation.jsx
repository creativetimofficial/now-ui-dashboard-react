...
import {
    ...
    Dropdown, DropdownToggle, DropdownMenu, DropdownItem, NavLink, Form, FormGroup, Input,
} from 'reactstrap';

import { Button } from 'components';

const colors = ["dark","success","danger","warning","white","primary","info"];
...
colors.map((prop,key) => {
    codeColorMap += `<Navbar expand="lg" color="`+prop+`">
        {/* navbar content */}
</Navbar>\n\n`;
    return null;
});
...
class Navigation extends React.Component{
    ...
    render(){
        return (
            <div>
                <h1 className="bd-title" id="content">Navbars</h1>
                <p className="bd-lead">
                    Documentation and examples for reactstrap's powerful, responsive navigation header, the navbar. Includes support for branding, navigation, and more, including support for our collapse plugin..
                </p>
                <h2>How it works</h2>
                <p>Here’s what you need to know before getting started with the navbar:</p>
                <ul>
                    <li>Navbars require a wrapping <code className="highlighter-rouge">Navbar</code> component with <code className="highlighter-rouge">{`expand={'sm'|'md'|'lg'|'xl'}`}</code> prop for responsive collapsing and <a href="#color-schemes">color</a> prop for color scheme classes.</li>
                    ...
                    <li>Navbars are hidden by default when printing. Force them to be printed by adding <code className="highlighter-rouge">.d-print</code> to the <code className="highlighter-rouge">Navbar</code>.</li>
                </ul>
                <p>Read on for an example and list of supported sub-components.</p>
                <h3>Navs</h3>
                <p><b>Navigation in navbars will also grow to occupy as much horizontal space as possible</b> to keep your navbar contents securely aligned.</p>
                <p>Active states—with <code className="highlighter-rouge">active</code> prop to indicate the current page can be applied directly to <code className="highlighter-rouge">NavLink</code>s or their immediate parent <code className="highlighter-rouge">NavItem</code>s.</p>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeNav}</SyntaxHighlighter>
                <p>You may also utilize dropdowns in your navbar nav. You will have to specify the <code>{`tag='nav'`}</code> prop.</p>
                <div className="bd-example" data-example-id="">
                    <Navbar expand="lg" color="primary">
                        <Container>
                            <NavbarBrand>Navbar</NavbarBrand>
                ...
                <div className="bd-example" data-example-id="">
                <SyntaxHighlighter language="jsx" style={prism} >{codeNavDropdown}</SyntaxHighlighter>
            </div>
                <h3>Forms</h3>
                <p>Place various form controls and components within a navbar with <code>inline</code> prop.</p>
                <div className="bd-example" data-example-id="">
                    <Navbar expand="lg" color="primary">
                        <Container>
                            <div className="navbar-translate">
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeNavForm}</SyntaxHighlighter>
                <h3>Text</h3>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeNavText}</SyntaxHighlighter>
                                ...
                                <Navbar expand="lg" color={prop} key={key}>
                                    <Container>
                                        ...
                                        <Collapse isOpen={this.state.isOpen} navbar>
                                            ...
                                            <Form inline className="ml-auto">
                                                <FormGroup className={prop !== 'white' ? "no-border":""}>
                                                    <Input type="text" placeholder="Search"/>
                                                </FormGroup>
                                                <Button color="neutral" icon round>
                                                    <i className="now-ui-icons ui-1_zoom-bold"></i>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeColor}</SyntaxHighlighter>
                <h2>Containers</h2>
                <p>When the container is within your navbar, its horizontal padding is removed at breakpoints lower than your specified <code className="highlighter-rouge">{`expand={'sm'|'md'|'lg'|'xl'}`}</code> prop. This ensures we’re not doubling up on padding unnecessarily on lower viewports when your navbar is collapsed.</p>
                <div className="bd-example" data-example-id="">
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeDefault}</SyntaxHighlighter>
                <div className="bd-example" data-example-id="">
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeFixedTop}</SyntaxHighlighter>
                <div className="bd-example" data-example-id="">
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeFixedBottom}</SyntaxHighlighter>
                <div className="bd-example" data-example-id="">
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeStickyTop}</SyntaxHighlighter>
                <h2>Responsive behaviors</h2>
                <p>Navbars can utilize <code className="highlighter-rouge">NavbarToggler</code>, <code className="highlighter-rouge">NavbarCollapse</code>, and <code className="highlighter-rouge">{`expand={'sm'|'md'|'lg'|'xl'}`}</code> to change when their content collapses behind a button. In combination with other utilities, you can easily choose when to show or hide particular elements.</p>
                <p>For navbars that never collapse, add the <code className="highlighter-rouge">expand</code> prop on the navbar. For navbars that always collapse, don’t add <code className="highlighter-rouge">expand</code> prop.</p>
                <h3>Toggler</h3>
                <p>Navbar togglers are left-aligned by default, but should they follow a sibling element like a <code className="highlighter-rouge">NavbarBrand</code>, they’ll automatically be aligned to the far right. Reversing your markup will reverse the placement of the toggler. Below are examples of different toggle styles.</p>
                <div className="bd-example" data-example-id="">
                    <Navbar expand="lg" color='primary'>
                        <Container>
                            <NavbarToggler onClick={this.toggle}>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeHidden}</SyntaxHighlighter>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeBrand}</SyntaxHighlighter>
                ...
                <SyntaxHighlighter language="jsx" style={prism}>{codeBrandRight}</SyntaxHighlighter>
                <h2>Props</h2>
